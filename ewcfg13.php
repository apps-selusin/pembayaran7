...
define("EW_PROJECT_NAME", "pembayaran7_prj", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{6E7B9E1D-9A99-4CA8-B431-15847F998A66}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'mfq7E4Nh1vO4XXqu', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/pembayaran7_prj.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_pembayaran7", "qs" => "`", "qe" => "`");
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "t9999_audittrail", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "t9999_audittrail", TRUE); // Audit trail table var
...
@define("EW_USER_LEVEL_TABLE", "`t9997_userlevels`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`t9998_userlevelpermissions`", TRUE);
...
define("EW_USER_TABLE", "`t9996_employees`", TRUE);
