...
$t9996_employees_edit = NULL; // Initialize page object first

class ct9996_employees_edit extends ct9996_employees {
	...
	// Page object name
	var $PageObjName = 't9996_employees_edit';
	...
	function Page_Init() {
		...
		if (!$Security->CanEdit()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("t9996_employeeslist.php"));
			else
	...
	function Page_Main() {
		...
		if ($this->EmployeeID->CurrentValue == "") {
			$this->Page_Terminate("t9996_employeeslist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t9996_employeeslist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "t9996_employeeslist.php")
	...
	function RenderRow() {
		...
		$this->Profile->ViewCustomAttributes = "";
			...
			$sSqlWrk = "SELECT `userlevelid`, `userlevelname` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld`, '' AS `SelectFilterFld`, '' AS `SelectFilterFld2`, '' AS `SelectFilterFld3`, '' AS `SelectFilterFld4` FROM `t9997_userlevels`";
			$sWhereWrk = "";
			$this->UserLevel->LookupFilters = array();
			ew_AddFilter($sWhereWrk, $sFilterWrk);
			$this->Lookup_Selecting($this->UserLevel, $sWhereWrk); // Call Lookup selecting
	...
	function SetupLookupFilters($fld, $pageId = null) {
		...
		case "x_UserLevel":
			$sSqlWrk = "";
			$sSqlWrk = "SELECT `userlevelid` AS `LinkFld`, `userlevelname` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `t9997_userlevels`";
			$sWhereWrk = "";
			$this->UserLevel->LookupFilters = array();
...
// Create page object
if (!isset($t9996_employees_edit)) $t9996_employees_edit = new ct9996_employees_edit();

// Page init
$t9996_employees_edit->Page_Init();

// Page main
$t9996_employees_edit->Page_Main();
...
var CurrentForm = ft9996_employeesedit = new ew_Form("ft9996_employeesedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckDateDef(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($t9996_employees->BirthDate->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_HireDate");
			if (elm && !ew_CheckDateDef(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($t9996_employees->HireDate->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_ReportsTo");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($t9996_employees->ReportsTo->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_Password");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9996_employees->Password->FldCaption(), $t9996_employees->Password->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_Password");
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9996_employees->Username->FldCaption(), $t9996_employees->Username->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_Activated");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9996_employees->Activated->FldCaption(), $t9996_employees->Activated->ReqErrMsg)) ?>");
...
ft9996_employeesedit.Form_CustomValidate = 
...
ft9996_employeesedit.ValidateRequired = true;
<?php } else { ?>
ft9996_employeesedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft9996_employeesedit.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t9997_userlevels"};
ft9996_employeesedit.Lists["x_Activated"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft9996_employeesedit.Lists["x_Activated"].Options = <?php echo json_encode($t9996_employees->Activated->Options()) ?>;
...
?>
<form name="ft9996_employeesedit" id="ft9996_employeesedit" class="<?php echo $t9996_employees_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9996_employees_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9996_employees_edit->Token ?>">
<?php } ?>
...
<?php if ($t9996_employees->EmployeeID->Visible) { // EmployeeID ?>
	<div id="r_EmployeeID" class="form-group">
		<label id="elh_t9996_employees_EmployeeID" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->EmployeeID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->EmployeeID->CellAttributes() ?>>
<span id="el_t9996_employees_EmployeeID">
<span<?php echo $t9996_employees->EmployeeID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t9996_employees->EmployeeID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t9996_employees" data-field="x_EmployeeID" name="x_EmployeeID" id="x_EmployeeID" value="<?php echo ew_HtmlEncode($t9996_employees->EmployeeID->CurrentValue) ?>">
...
<?php if ($t9996_employees->LastName->Visible) { // LastName ?>
	<div id="r_LastName" class="form-group">
		<label id="elh_t9996_employees_LastName" for="x_LastName" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->LastName->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->LastName->CellAttributes() ?>>
<span id="el_t9996_employees_LastName">
<input type="text" data-table="t9996_employees" data-field="x_LastName" name="x_LastName" id="x_LastName" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($t9996_employees->LastName->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->LastName->EditValue ?>"<?php echo $t9996_employees->LastName->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->FirstName->Visible) { // FirstName ?>
	<div id="r_FirstName" class="form-group">
		<label id="elh_t9996_employees_FirstName" for="x_FirstName" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->FirstName->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->FirstName->CellAttributes() ?>>
<span id="el_t9996_employees_FirstName">
<input type="text" data-table="t9996_employees" data-field="x_FirstName" name="x_FirstName" id="x_FirstName" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($t9996_employees->FirstName->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->FirstName->EditValue ?>"<?php echo $t9996_employees->FirstName->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Title->Visible) { // Title ?>
	<div id="r_Title" class="form-group">
		<label id="elh_t9996_employees_Title" for="x_Title" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Title->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Title->CellAttributes() ?>>
<span id="el_t9996_employees_Title">
<input type="text" data-table="t9996_employees" data-field="x_Title" name="x_Title" id="x_Title" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Title->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->Title->EditValue ?>"<?php echo $t9996_employees->Title->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->TitleOfCourtesy->Visible) { // TitleOfCourtesy ?>
	<div id="r_TitleOfCourtesy" class="form-group">
		<label id="elh_t9996_employees_TitleOfCourtesy" for="x_TitleOfCourtesy" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->TitleOfCourtesy->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->TitleOfCourtesy->CellAttributes() ?>>
<span id="el_t9996_employees_TitleOfCourtesy">
<input type="text" data-table="t9996_employees" data-field="x_TitleOfCourtesy" name="x_TitleOfCourtesy" id="x_TitleOfCourtesy" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($t9996_employees->TitleOfCourtesy->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->TitleOfCourtesy->EditValue ?>"<?php echo $t9996_employees->TitleOfCourtesy->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->BirthDate->Visible) { // BirthDate ?>
	<div id="r_BirthDate" class="form-group">
		<label id="elh_t9996_employees_BirthDate" for="x_BirthDate" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->BirthDate->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->BirthDate->CellAttributes() ?>>
<span id="el_t9996_employees_BirthDate">
<input type="text" data-table="t9996_employees" data-field="x_BirthDate" name="x_BirthDate" id="x_BirthDate" placeholder="<?php echo ew_HtmlEncode($t9996_employees->BirthDate->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->BirthDate->EditValue ?>"<?php echo $t9996_employees->BirthDate->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->HireDate->Visible) { // HireDate ?>
	<div id="r_HireDate" class="form-group">
		<label id="elh_t9996_employees_HireDate" for="x_HireDate" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->HireDate->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->HireDate->CellAttributes() ?>>
<span id="el_t9996_employees_HireDate">
<input type="text" data-table="t9996_employees" data-field="x_HireDate" name="x_HireDate" id="x_HireDate" placeholder="<?php echo ew_HtmlEncode($t9996_employees->HireDate->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->HireDate->EditValue ?>"<?php echo $t9996_employees->HireDate->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group">
		<label id="elh_t9996_employees_Address" for="x_Address" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Address->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Address->CellAttributes() ?>>
<span id="el_t9996_employees_Address">
<input type="text" data-table="t9996_employees" data-field="x_Address" name="x_Address" id="x_Address" size="30" maxlength="60" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Address->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->Address->EditValue ?>"<?php echo $t9996_employees->Address->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->City->Visible) { // City ?>
	<div id="r_City" class="form-group">
		<label id="elh_t9996_employees_City" for="x_City" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->City->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->City->CellAttributes() ?>>
<span id="el_t9996_employees_City">
<input type="text" data-table="t9996_employees" data-field="x_City" name="x_City" id="x_City" size="30" maxlength="15" placeholder="<?php echo ew_HtmlEncode($t9996_employees->City->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->City->EditValue ?>"<?php echo $t9996_employees->City->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Region->Visible) { // Region ?>
	<div id="r_Region" class="form-group">
		<label id="elh_t9996_employees_Region" for="x_Region" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Region->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Region->CellAttributes() ?>>
<span id="el_t9996_employees_Region">
<input type="text" data-table="t9996_employees" data-field="x_Region" name="x_Region" id="x_Region" size="30" maxlength="15" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Region->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->Region->EditValue ?>"<?php echo $t9996_employees->Region->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->PostalCode->Visible) { // PostalCode ?>
	<div id="r_PostalCode" class="form-group">
		<label id="elh_t9996_employees_PostalCode" for="x_PostalCode" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->PostalCode->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->PostalCode->CellAttributes() ?>>
<span id="el_t9996_employees_PostalCode">
<input type="text" data-table="t9996_employees" data-field="x_PostalCode" name="x_PostalCode" id="x_PostalCode" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($t9996_employees->PostalCode->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->PostalCode->EditValue ?>"<?php echo $t9996_employees->PostalCode->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Country->Visible) { // Country ?>
	<div id="r_Country" class="form-group">
		<label id="elh_t9996_employees_Country" for="x_Country" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Country->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Country->CellAttributes() ?>>
<span id="el_t9996_employees_Country">
<input type="text" data-table="t9996_employees" data-field="x_Country" name="x_Country" id="x_Country" size="30" maxlength="15" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Country->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->Country->EditValue ?>"<?php echo $t9996_employees->Country->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->HomePhone->Visible) { // HomePhone ?>
	<div id="r_HomePhone" class="form-group">
		<label id="elh_t9996_employees_HomePhone" for="x_HomePhone" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->HomePhone->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->HomePhone->CellAttributes() ?>>
<span id="el_t9996_employees_HomePhone">
<input type="text" data-table="t9996_employees" data-field="x_HomePhone" name="x_HomePhone" id="x_HomePhone" size="30" maxlength="24" placeholder="<?php echo ew_HtmlEncode($t9996_employees->HomePhone->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->HomePhone->EditValue ?>"<?php echo $t9996_employees->HomePhone->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Extension->Visible) { // Extension ?>
	<div id="r_Extension" class="form-group">
		<label id="elh_t9996_employees_Extension" for="x_Extension" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Extension->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Extension->CellAttributes() ?>>
<span id="el_t9996_employees_Extension">
<input type="text" data-table="t9996_employees" data-field="x_Extension" name="x_Extension" id="x_Extension" size="30" maxlength="4" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Extension->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->Extension->EditValue ?>"<?php echo $t9996_employees->Extension->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->_Email->Visible) { // Email ?>
	<div id="r__Email" class="form-group">
		<label id="elh_t9996_employees__Email" for="x__Email" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->_Email->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->_Email->CellAttributes() ?>>
<span id="el_t9996_employees__Email">
<input type="text" data-table="t9996_employees" data-field="x__Email" name="x__Email" id="x__Email" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($t9996_employees->_Email->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->_Email->EditValue ?>"<?php echo $t9996_employees->_Email->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Photo->Visible) { // Photo ?>
	<div id="r_Photo" class="form-group">
		<label id="elh_t9996_employees_Photo" for="x_Photo" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Photo->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Photo->CellAttributes() ?>>
<span id="el_t9996_employees_Photo">
<input type="text" data-table="t9996_employees" data-field="x_Photo" name="x_Photo" id="x_Photo" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Photo->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->Photo->EditValue ?>"<?php echo $t9996_employees->Photo->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group">
		<label id="elh_t9996_employees_Notes" for="x_Notes" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Notes->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Notes->CellAttributes() ?>>
<span id="el_t9996_employees_Notes">
<textarea data-table="t9996_employees" data-field="x_Notes" name="x_Notes" id="x_Notes" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Notes->getPlaceHolder()) ?>"<?php echo $t9996_employees->Notes->EditAttributes() ?>><?php echo $t9996_employees->Notes->EditValue ?></textarea>
</span>
...
<?php if ($t9996_employees->ReportsTo->Visible) { // ReportsTo ?>
	<div id="r_ReportsTo" class="form-group">
		<label id="elh_t9996_employees_ReportsTo" for="x_ReportsTo" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->ReportsTo->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->ReportsTo->CellAttributes() ?>>
<span id="el_t9996_employees_ReportsTo">
<input type="text" data-table="t9996_employees" data-field="x_ReportsTo" name="x_ReportsTo" id="x_ReportsTo" size="30" placeholder="<?php echo ew_HtmlEncode($t9996_employees->ReportsTo->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->ReportsTo->EditValue ?>"<?php echo $t9996_employees->ReportsTo->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Password->Visible) { // Password ?>
	<div id="r_Password" class="form-group">
		<label id="elh_t9996_employees_Password" for="x_Password" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Password->CellAttributes() ?>>
<span id="el_t9996_employees_Password">
<div class="input-group" id="ig_Password">
<input type="text" data-password-strength="pst_Password" data-password-generated="pgt_Password" data-table="t9996_employees" data-field="x_Password" name="x_Password" id="x_Password" value="<?php echo $t9996_employees->Password->EditValue ?>" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Password->getPlaceHolder()) ?>"<?php echo $t9996_employees->Password->EditAttributes() ?>>
...
<?php if ($t9996_employees->UserLevel->Visible) { // UserLevel ?>
	<div id="r_UserLevel" class="form-group">
		<label id="elh_t9996_employees_UserLevel" for="x_UserLevel" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->UserLevel->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->UserLevel->CellAttributes() ?>>
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn()) { // Non system admin ?>
<span id="el_t9996_employees_UserLevel">
<p class="form-control-static"><?php echo $t9996_employees->UserLevel->EditValue ?></p>
</span>
<?php } else { ?>
<span id="el_t9996_employees_UserLevel">
<select data-table="t9996_employees" data-field="x_UserLevel" data-value-separator="<?php echo $t9996_employees->UserLevel->DisplayValueSeparatorAttribute() ?>" id="x_UserLevel" name="x_UserLevel"<?php echo $t9996_employees->UserLevel->EditAttributes() ?>>
<?php echo $t9996_employees->UserLevel->SelectOptionListHtml("x_UserLevel") ?>
</select>
<input type="hidden" name="s_x_UserLevel" id="s_x_UserLevel" value="<?php echo $t9996_employees->UserLevel->LookupFilterQuery() ?>">
</span>
<?php } ?>
...
<?php if ($t9996_employees->Username->Visible) { // Username ?>
	<div id="r_Username" class="form-group">
		<label id="elh_t9996_employees_Username" for="x_Username" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Username->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Username->CellAttributes() ?>>
<span id="el_t9996_employees_Username">
<input type="text" data-table="t9996_employees" data-field="x_Username" name="x_Username" id="x_Username" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Username->getPlaceHolder()) ?>" value="<?php echo $t9996_employees->Username->EditValue ?>"<?php echo $t9996_employees->Username->EditAttributes() ?>>
</span>
...
<?php if ($t9996_employees->Activated->Visible) { // Activated ?>
	<div id="r_Activated" class="form-group">
		<label id="elh_t9996_employees_Activated" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Activated->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Activated->CellAttributes() ?>>
...
<?php if ($t9996_employees->Profile->Visible) { // Profile ?>
	<div id="r_Profile" class="form-group">
		<label id="elh_t9996_employees_Profile" for="x_Profile" class="col-sm-2 control-label ewLabel"><?php echo $t9996_employees->Profile->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t9996_employees->Profile->CellAttributes() ?>>
<span id="el_t9996_employees_Profile">
<textarea data-table="t9996_employees" data-field="x_Profile" name="x_Profile" id="x_Profile" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($t9996_employees->Profile->getPlaceHolder()) ?>"<?php echo $t9996_employees->Profile->EditAttributes() ?>><?php echo $t9996_employees->Profile->EditValue ?></textarea>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9996_employees_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9996_employeesedit.Init();
</script>
<?php
...
<?php
$t9996_employees_edit->Page_Terminate();
?>
