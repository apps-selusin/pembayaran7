...
$t0302_bayardetail_delete = NULL; // Initialize page object first

class ct0302_bayardetail_delete extends ct0302_bayardetail {
	...
	// Page object name
	var $PageObjName = 't0302_bayardetail_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t0302_bayardetaillist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t0302_bayardetail class, t0302_bayardetailinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t0302_bayardetaillist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t0302_bayardetail_delete)) $t0302_bayardetail_delete = new ct0302_bayardetail_delete();

// Page init
$t0302_bayardetail_delete->Page_Init();

// Page main
$t0302_bayardetail_delete->Page_Main();
...
var CurrentForm = ft0302_bayardetaildelete = new ew_Form("ft0302_bayardetaildelete", "delete");

// Form_CustomValidate event
ft0302_bayardetaildelete.Form_CustomValidate = 
...
ft0302_bayardetaildelete.ValidateRequired = true;
<?php } else { ?>
ft0302_bayardetaildelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0302_bayardetaildelete.Lists["x_iuran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Iuran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0106_iuran"};
ft0302_bayardetaildelete.Lists["x_Periode1"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0302_bayardetaildelete.Lists["x_Periode1"].Options = <?php echo json_encode($t0302_bayardetail->Periode1->Options()) ?>;
ft0302_bayardetaildelete.Lists["x_Periode2"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0302_bayardetaildelete.Lists["x_Periode2"].Options = <?php echo json_encode($t0302_bayardetail->Periode2->Options()) ?>;
...
?>
<form name="ft0302_bayardetaildelete" id="ft0302_bayardetaildelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0302_bayardetail_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0302_bayardetail_delete->Token ?>">
<?php } ?>
...
<?php if ($t0302_bayardetail->iuran_id->Visible) { // iuran_id ?>
		<th><span id="elh_t0302_bayardetail_iuran_id" class="t0302_bayardetail_iuran_id"><?php echo $t0302_bayardetail->iuran_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0302_bayardetail->Periode1->Visible) { // Periode1 ?>
		<th><span id="elh_t0302_bayardetail_Periode1" class="t0302_bayardetail_Periode1"><?php echo $t0302_bayardetail->Periode1->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0302_bayardetail->Periode2->Visible) { // Periode2 ?>
		<th><span id="elh_t0302_bayardetail_Periode2" class="t0302_bayardetail_Periode2"><?php echo $t0302_bayardetail->Periode2->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0302_bayardetail->Keterangan->Visible) { // Keterangan ?>
		<th><span id="elh_t0302_bayardetail_Keterangan" class="t0302_bayardetail_Keterangan"><?php echo $t0302_bayardetail->Keterangan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0302_bayardetail->Jumlah->Visible) { // Jumlah ?>
		<th><span id="elh_t0302_bayardetail_Jumlah" class="t0302_bayardetail_Jumlah"><?php echo $t0302_bayardetail->Jumlah->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
while (!$t0302_bayardetail_delete->Recordset->EOF) {
	...
	$t0302_bayardetail->RowType = EW_ROWTYPE_VIEW; // View
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0302_bayardetail_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft0302_bayardetaildelete.Init();
</script>
<?php
...
<?php
$t0302_bayardetail_delete->Page_Terminate();
?>
