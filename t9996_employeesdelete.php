...
$t9996_employees_delete = NULL; // Initialize page object first

class ct9996_employees_delete extends ct9996_employees {
	...
	// Page object name
	var $PageObjName = 't9996_employees_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t9996_employeeslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t9996_employees class, t9996_employeesinfo.php
		...
		if ($this->Recordset = ew_LoadRecordset($sql, $conn)) {
			...
			if (!$res) $this->Page_Terminate("t9996_employeeslist.php"); // Return to list
		}
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				if ($this->Recordset)
					$this->Recordset->Close();
				$this->Page_Terminate("t9996_employeeslist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t9996_employees_delete)) $t9996_employees_delete = new ct9996_employees_delete();

// Page init
$t9996_employees_delete->Page_Init();

// Page main
$t9996_employees_delete->Page_Main();
...
var CurrentForm = ft9996_employeesdelete = new ew_Form("ft9996_employeesdelete", "delete");

// Form_CustomValidate event
ft9996_employeesdelete.Form_CustomValidate = 
...
ft9996_employeesdelete.ValidateRequired = true;
<?php } else { ?>
ft9996_employeesdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft9996_employeesdelete.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t9997_userlevels"};
ft9996_employeesdelete.Lists["x_Activated"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft9996_employeesdelete.Lists["x_Activated"].Options = <?php echo json_encode($t9996_employees->Activated->Options()) ?>;
...
?>
<form name="ft9996_employeesdelete" id="ft9996_employeesdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9996_employees_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9996_employees_delete->Token ?>">
<?php } ?>
...
<?php if ($t9996_employees->EmployeeID->Visible) { // EmployeeID ?>
		<th><span id="elh_t9996_employees_EmployeeID" class="t9996_employees_EmployeeID"><?php echo $t9996_employees->EmployeeID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->LastName->Visible) { // LastName ?>
		<th><span id="elh_t9996_employees_LastName" class="t9996_employees_LastName"><?php echo $t9996_employees->LastName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->FirstName->Visible) { // FirstName ?>
		<th><span id="elh_t9996_employees_FirstName" class="t9996_employees_FirstName"><?php echo $t9996_employees->FirstName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Title->Visible) { // Title ?>
		<th><span id="elh_t9996_employees_Title" class="t9996_employees_Title"><?php echo $t9996_employees->Title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->TitleOfCourtesy->Visible) { // TitleOfCourtesy ?>
		<th><span id="elh_t9996_employees_TitleOfCourtesy" class="t9996_employees_TitleOfCourtesy"><?php echo $t9996_employees->TitleOfCourtesy->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->BirthDate->Visible) { // BirthDate ?>
		<th><span id="elh_t9996_employees_BirthDate" class="t9996_employees_BirthDate"><?php echo $t9996_employees->BirthDate->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->HireDate->Visible) { // HireDate ?>
		<th><span id="elh_t9996_employees_HireDate" class="t9996_employees_HireDate"><?php echo $t9996_employees->HireDate->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Address->Visible) { // Address ?>
		<th><span id="elh_t9996_employees_Address" class="t9996_employees_Address"><?php echo $t9996_employees->Address->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->City->Visible) { // City ?>
		<th><span id="elh_t9996_employees_City" class="t9996_employees_City"><?php echo $t9996_employees->City->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Region->Visible) { // Region ?>
		<th><span id="elh_t9996_employees_Region" class="t9996_employees_Region"><?php echo $t9996_employees->Region->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->PostalCode->Visible) { // PostalCode ?>
		<th><span id="elh_t9996_employees_PostalCode" class="t9996_employees_PostalCode"><?php echo $t9996_employees->PostalCode->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Country->Visible) { // Country ?>
		<th><span id="elh_t9996_employees_Country" class="t9996_employees_Country"><?php echo $t9996_employees->Country->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->HomePhone->Visible) { // HomePhone ?>
		<th><span id="elh_t9996_employees_HomePhone" class="t9996_employees_HomePhone"><?php echo $t9996_employees->HomePhone->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Extension->Visible) { // Extension ?>
		<th><span id="elh_t9996_employees_Extension" class="t9996_employees_Extension"><?php echo $t9996_employees->Extension->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->_Email->Visible) { // Email ?>
		<th><span id="elh_t9996_employees__Email" class="t9996_employees__Email"><?php echo $t9996_employees->_Email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Photo->Visible) { // Photo ?>
		<th><span id="elh_t9996_employees_Photo" class="t9996_employees_Photo"><?php echo $t9996_employees->Photo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->ReportsTo->Visible) { // ReportsTo ?>
		<th><span id="elh_t9996_employees_ReportsTo" class="t9996_employees_ReportsTo"><?php echo $t9996_employees->ReportsTo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Password->Visible) { // Password ?>
		<th><span id="elh_t9996_employees_Password" class="t9996_employees_Password"><?php echo $t9996_employees->Password->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->UserLevel->Visible) { // UserLevel ?>
		<th><span id="elh_t9996_employees_UserLevel" class="t9996_employees_UserLevel"><?php echo $t9996_employees->UserLevel->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Username->Visible) { // Username ?>
		<th><span id="elh_t9996_employees_Username" class="t9996_employees_Username"><?php echo $t9996_employees->Username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9996_employees->Activated->Visible) { // Activated ?>
		<th><span id="elh_t9996_employees_Activated" class="t9996_employees_Activated"><?php echo $t9996_employees->Activated->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
while (!$t9996_employees_delete->Recordset->EOF) {
	...
	$t9996_employees->RowType = EW_ROWTYPE_VIEW; // View
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9996_employees_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft9996_employeesdelete.Init();
</script>
<?php
...
<?php
$t9996_employees_delete->Page_Terminate();
?>
