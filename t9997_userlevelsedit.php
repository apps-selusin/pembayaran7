...
$t9997_userlevels_edit = NULL; // Initialize page object first

class ct9997_userlevels_edit extends ct9997_userlevels {
	...
	// Page object name
	var $PageObjName = 't9997_userlevels_edit';
	...
	function Page_Main() {
		...
		if ($this->userlevelid->CurrentValue == "") {
			$this->Page_Terminate("t9997_userlevelslist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t9997_userlevels_edit)) $t9997_userlevels_edit = new ct9997_userlevels_edit();

// Page init
$t9997_userlevels_edit->Page_Init();

// Page main
$t9997_userlevels_edit->Page_Main();
...
var CurrentForm = ft9997_userlevelsedit = new ew_Form("ft9997_userlevelsedit", "edit");
...
ft9997_userlevelsedit.Form_CustomValidate = 
...
ft9997_userlevelsedit.ValidateRequired = true;
<?php } else { ?>
ft9997_userlevelsedit.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="ft9997_userlevelsedit" id="ft9997_userlevelsedit" class="<?php echo $t9997_userlevels_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9997_userlevels_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9997_userlevels_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $t9997_userlevels->userlevelid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t9997_userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" value="<?php echo ew_HtmlEncode($t9997_userlevels->userlevelid->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9997_userlevels_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9997_userlevelsedit.Init();
</script>
<?php
...
<?php
$t9997_userlevels_edit->Page_Terminate();
?>
