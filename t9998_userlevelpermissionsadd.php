...
$t9998_userlevelpermissions_add = NULL; // Initialize page object first

class ct9998_userlevelpermissions_add extends ct9998_userlevelpermissions {
	...
	// Page object name
	var $PageObjName = 't9998_userlevelpermissions_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t9998_userlevelpermissionsview.php")
...
// Create page object
if (!isset($t9998_userlevelpermissions_add)) $t9998_userlevelpermissions_add = new ct9998_userlevelpermissions_add();

// Page init
$t9998_userlevelpermissions_add->Page_Init();

// Page main
$t9998_userlevelpermissions_add->Page_Main();
...
var CurrentForm = ft9998_userlevelpermissionsadd = new ew_Form("ft9998_userlevelpermissionsadd", "add");
...
ft9998_userlevelpermissionsadd.Form_CustomValidate = 
...
ft9998_userlevelpermissionsadd.ValidateRequired = true;
<?php } else { ?>
ft9998_userlevelpermissionsadd.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="ft9998_userlevelpermissionsadd" id="ft9998_userlevelpermissionsadd" class="<?php echo $t9998_userlevelpermissions_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9998_userlevelpermissions_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9998_userlevelpermissions_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="t9998_userlevelpermissions" data-field="x__tablename" name="x__tablename" id="x__tablename" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($t9998_userlevelpermissions->_tablename->getPlaceHolder()) ?>" value="<?php echo $t9998_userlevelpermissions->_tablename->EditValue ?>"<?php echo $t9998_userlevelpermissions->_tablename->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9998_userlevelpermissions_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9998_userlevelpermissionsadd.Init();
</script>
<?php
...
<?php
$t9998_userlevelpermissions_add->Page_Terminate();
?>
