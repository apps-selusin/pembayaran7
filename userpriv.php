...
class cuserpriv extends ct9997_userlevels {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t9997_userlevels"])) $GLOBALS["t9997_userlevels"] = &$this;
...
<p><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->GetUserLevelName($t9997_userlevels->userlevelid->CurrentValue) ?>(<?php echo $t9997_userlevels->userlevelid->CurrentValue ?>)</p>
<?php
...
for ($i = 0; $i < $userpriv->TableNameCount; $i++) {
	$userpriv->TempPriv = $Security->GetUserLevelPrivEx($userpriv->TableList[$i][4] . $userpriv->TableList[$i][0], $t9997_userlevels->userlevelid->CurrentValue);
