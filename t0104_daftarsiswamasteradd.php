...
$t0104_daftarsiswamaster_add = NULL; // Initialize page object first

class ct0104_daftarsiswamaster_add extends ct0104_daftarsiswamaster {
	...
	// Page object name
	var $PageObjName = 't0104_daftarsiswamaster_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t0104_daftarsiswamasterview.php")
...
// Create page object
if (!isset($t0104_daftarsiswamaster_add)) $t0104_daftarsiswamaster_add = new ct0104_daftarsiswamaster_add();

// Page init
$t0104_daftarsiswamaster_add->Page_Init();

// Page main
$t0104_daftarsiswamaster_add->Page_Main();
...
var CurrentForm = ft0104_daftarsiswamasteradd = new ew_Form("ft0104_daftarsiswamasteradd", "add");
...
ft0104_daftarsiswamasteradd.Form_CustomValidate = 
...
ft0104_daftarsiswamasteradd.ValidateRequired = true;
<?php } else { ?>
ft0104_daftarsiswamasteradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0104_daftarsiswamasteradd.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0101_tahunajaran"};
ft0104_daftarsiswamasteradd.Lists["x_sekolah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Sekolah","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0102_sekolah"};
ft0104_daftarsiswamasteradd.Lists["x_kelas_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kelas","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0103_kelas"};
...
?>
<form name="ft0104_daftarsiswamasteradd" id="ft0104_daftarsiswamasteradd" class="<?php echo $t0104_daftarsiswamaster_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0104_daftarsiswamaster_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0104_daftarsiswamaster_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0104_daftarsiswamaster_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0104_daftarsiswamasteradd.Init();
</script>
<?php
...
<?php
$t0104_daftarsiswamaster_add->Page_Terminate();
?>
