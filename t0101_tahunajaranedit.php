...
$t0101_tahunajaran_edit = NULL; // Initialize page object first

class ct0101_tahunajaran_edit extends ct0101_tahunajaran {
	...
	// Page object name
	var $PageObjName = 't0101_tahunajaran_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t0101_tahunajaranlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t0101_tahunajaran_edit)) $t0101_tahunajaran_edit = new ct0101_tahunajaran_edit();

// Page init
$t0101_tahunajaran_edit->Page_Init();

// Page main
$t0101_tahunajaran_edit->Page_Main();
...
var CurrentForm = ft0101_tahunajaranedit = new ew_Form("ft0101_tahunajaranedit", "edit");
...
ft0101_tahunajaranedit.Form_CustomValidate = 
...
ft0101_tahunajaranedit.ValidateRequired = true;
<?php } else { ?>
ft0101_tahunajaranedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0101_tahunajaranedit.Lists["x_Aktif"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0101_tahunajaranedit.Lists["x_Aktif"].Options = <?php echo json_encode($t0101_tahunajaran->Aktif->Options()) ?>;
...
?>
<form name="ft0101_tahunajaranedit" id="ft0101_tahunajaranedit" class="<?php echo $t0101_tahunajaran_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0101_tahunajaran_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0101_tahunajaran_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t0101_tahunajaran" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t0101_tahunajaran->id->CurrentValue) ?>">
<?php if (!$t0101_tahunajaran_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0101_tahunajaran_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0101_tahunajaranedit.Init();
</script>
<?php
...
<?php
$t0101_tahunajaran_edit->Page_Terminate();
?>
