...
$t0105_daftarsiswadetail_add = NULL; // Initialize page object first

class ct0105_daftarsiswadetail_add extends ct0105_daftarsiswadetail {
	...
	// Page object name
	var $PageObjName = 't0105_daftarsiswadetail_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t0105_daftarsiswadetailview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->daftarsiswamaster_id->getSessionValue() <> "") {
			$sMasterFilter = str_replace("@id@", ew_AdjustSql($this->daftarsiswamaster_id->getSessionValue(), "DB"), $sMasterFilter);
		} else {
...
// Create page object
if (!isset($t0105_daftarsiswadetail_add)) $t0105_daftarsiswadetail_add = new ct0105_daftarsiswadetail_add();

// Page init
$t0105_daftarsiswadetail_add->Page_Init();

// Page main
$t0105_daftarsiswadetail_add->Page_Main();
...
var CurrentForm = ft0105_daftarsiswadetailadd = new ew_Form("ft0105_daftarsiswadetailadd", "add");
...
ft0105_daftarsiswadetailadd.Form_CustomValidate = 
...
ft0105_daftarsiswadetailadd.ValidateRequired = true;
<?php } else { ?>
ft0105_daftarsiswadetailadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0105_daftarsiswadetailadd.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_NIS","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0201_siswa"};
...
?>
<form name="ft0105_daftarsiswadetailadd" id="ft0105_daftarsiswadetailadd" class="<?php echo $t0105_daftarsiswadetail_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0105_daftarsiswadetail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0105_daftarsiswadetail_add->Token ?>">
<?php } ?>
...
<input type="hidden" name="x_daftarsiswamaster_id" id="x_daftarsiswamaster_id" value="<?php echo ew_HtmlEncode(strval($t0105_daftarsiswadetail->daftarsiswamaster_id->getSessionValue())) ?>">
<?php } ?>
<?php if (!$t0105_daftarsiswadetail_add->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0105_daftarsiswadetail_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0105_daftarsiswadetailadd.Init();
</script>
<?php
...
<?php
$t0105_daftarsiswadetail_add->Page_Terminate();
?>
