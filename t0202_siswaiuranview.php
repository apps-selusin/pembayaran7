...
$t0202_siswaiuran_view = NULL; // Initialize page object first

class ct0202_siswaiuran_view extends ct0202_siswaiuran {
	...
	// Page object name
	var $PageObjName = 't0202_siswaiuran_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t0202_siswaiuranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t0202_siswaiuranlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "t0202_siswaiuranlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t0202_siswaiuran_view)) $t0202_siswaiuran_view = new ct0202_siswaiuran_view();

// Page init
$t0202_siswaiuran_view->Page_Init();

// Page main
$t0202_siswaiuran_view->Page_Main();
...
var CurrentForm = ft0202_siswaiuranview = new ew_Form("ft0202_siswaiuranview", "view");

// Form_CustomValidate event
ft0202_siswaiuranview.Form_CustomValidate = 
...
ft0202_siswaiuranview.ValidateRequired = true;
<?php } else { ?>
ft0202_siswaiuranview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0202_siswaiuranview.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0101_tahunajaran"};
ft0202_siswaiuranview.Lists["x_iuran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Iuran","x_Jenis","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0106_iuran"};
...
<?php if ($t0202_siswaiuran->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t0202_siswaiuran_view->IsModal) { ?>
<?php if ($t0202_siswaiuran->Export == "") { ?>
...
<?php
	foreach ($t0202_siswaiuran_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t0202_siswaiuran_view->IsModal) { ?>
<?php if ($t0202_siswaiuran->Export == "") { ?>
...
?>
<form name="ft0202_siswaiuranview" id="ft0202_siswaiuranview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0202_siswaiuran_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0202_siswaiuran_view->Token ?>">
<?php } ?>
...
<?php if ($t0202_siswaiuran->tahunajaran_id->Visible) { // tahunajaran_id ?>
	<tr id="r_tahunajaran_id">
		<td><span id="elh_t0202_siswaiuran_tahunajaran_id"><?php echo $t0202_siswaiuran->tahunajaran_id->FldCaption() ?></span></td>
...
<?php echo $t0202_siswaiuran->tahunajaran_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0202_siswaiuran->iuran_id->Visible) { // iuran_id ?>
	<tr id="r_iuran_id">
		<td><span id="elh_t0202_siswaiuran_iuran_id"><?php echo $t0202_siswaiuran->iuran_id->FldCaption() ?></span></td>
...
<?php echo $t0202_siswaiuran->iuran_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0202_siswaiuran->Nilai->Visible) { // Nilai ?>
	<tr id="r_Nilai">
		<td><span id="elh_t0202_siswaiuran_Nilai"><?php echo $t0202_siswaiuran->Nilai->FldCaption() ?></span></td>
...
<?php echo $t0202_siswaiuran->Nilai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$t0202_siswaiuran_view->Page_Terminate();
?>
