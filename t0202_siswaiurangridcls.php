...
$t0202_siswaiuran_grid = NULL; // Initialize page object first

class ct0202_siswaiuran_grid extends ct0202_siswaiuran {
	...
	// Page object name
	var $PageObjName = 't0202_siswaiuran_grid';

	// Grid form hidden field names
	var $FormName = 'ft0202_siswaiurangrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t0202_siswaiuran"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t0201_siswa") {
			...
			if ($GLOBALS["t0201_siswa"]->EventCancelled) $this->EventCancelled = TRUE;
		}
