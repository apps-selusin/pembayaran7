...
$t9996_employees_view = NULL; // Initialize page object first

class ct9996_employees_view extends ct9996_employees {
	...
	// Page object name
	var $PageObjName = 't9996_employees_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["EmployeeID"] <> "") {
				...
				$sReturnUrl = "t9996_employeeslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t9996_employeeslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "t9996_employeeslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t9996_employees_view)) $t9996_employees_view = new ct9996_employees_view();

// Page init
$t9996_employees_view->Page_Init();

// Page main
$t9996_employees_view->Page_Main();
...
var CurrentForm = ft9996_employeesview = new ew_Form("ft9996_employeesview", "view");

// Form_CustomValidate event
ft9996_employeesview.Form_CustomValidate = 
...
ft9996_employeesview.ValidateRequired = true;
<?php } else { ?>
ft9996_employeesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft9996_employeesview.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t9997_userlevels"};
ft9996_employeesview.Lists["x_Activated"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft9996_employeesview.Lists["x_Activated"].Options = <?php echo json_encode($t9996_employees->Activated->Options()) ?>;
...
<?php if ($t9996_employees->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t9996_employees_view->IsModal) { ?>
<?php if ($t9996_employees->Export == "") { ?>
...
<?php
	foreach ($t9996_employees_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t9996_employees_view->IsModal) { ?>
<?php if ($t9996_employees->Export == "") { ?>
...
?>
<form name="ft9996_employeesview" id="ft9996_employeesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9996_employees_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9996_employees_view->Token ?>">
<?php } ?>
...
<?php if ($t9996_employees->EmployeeID->Visible) { // EmployeeID ?>
	<tr id="r_EmployeeID">
		<td><span id="elh_t9996_employees_EmployeeID"><?php echo $t9996_employees->EmployeeID->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->EmployeeID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->LastName->Visible) { // LastName ?>
	<tr id="r_LastName">
		<td><span id="elh_t9996_employees_LastName"><?php echo $t9996_employees->LastName->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->LastName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->FirstName->Visible) { // FirstName ?>
	<tr id="r_FirstName">
		<td><span id="elh_t9996_employees_FirstName"><?php echo $t9996_employees->FirstName->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->FirstName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Title->Visible) { // Title ?>
	<tr id="r_Title">
		<td><span id="elh_t9996_employees_Title"><?php echo $t9996_employees->Title->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->TitleOfCourtesy->Visible) { // TitleOfCourtesy ?>
	<tr id="r_TitleOfCourtesy">
		<td><span id="elh_t9996_employees_TitleOfCourtesy"><?php echo $t9996_employees->TitleOfCourtesy->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->TitleOfCourtesy->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->BirthDate->Visible) { // BirthDate ?>
	<tr id="r_BirthDate">
		<td><span id="elh_t9996_employees_BirthDate"><?php echo $t9996_employees->BirthDate->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->BirthDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->HireDate->Visible) { // HireDate ?>
	<tr id="r_HireDate">
		<td><span id="elh_t9996_employees_HireDate"><?php echo $t9996_employees->HireDate->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->HireDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Address->Visible) { // Address ?>
	<tr id="r_Address">
		<td><span id="elh_t9996_employees_Address"><?php echo $t9996_employees->Address->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->City->Visible) { // City ?>
	<tr id="r_City">
		<td><span id="elh_t9996_employees_City"><?php echo $t9996_employees->City->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->City->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Region->Visible) { // Region ?>
	<tr id="r_Region">
		<td><span id="elh_t9996_employees_Region"><?php echo $t9996_employees->Region->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Region->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->PostalCode->Visible) { // PostalCode ?>
	<tr id="r_PostalCode">
		<td><span id="elh_t9996_employees_PostalCode"><?php echo $t9996_employees->PostalCode->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->PostalCode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Country->Visible) { // Country ?>
	<tr id="r_Country">
		<td><span id="elh_t9996_employees_Country"><?php echo $t9996_employees->Country->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Country->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->HomePhone->Visible) { // HomePhone ?>
	<tr id="r_HomePhone">
		<td><span id="elh_t9996_employees_HomePhone"><?php echo $t9996_employees->HomePhone->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->HomePhone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Extension->Visible) { // Extension ?>
	<tr id="r_Extension">
		<td><span id="elh_t9996_employees_Extension"><?php echo $t9996_employees->Extension->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Extension->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->_Email->Visible) { // Email ?>
	<tr id="r__Email">
		<td><span id="elh_t9996_employees__Email"><?php echo $t9996_employees->_Email->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->_Email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Photo->Visible) { // Photo ?>
	<tr id="r_Photo">
		<td><span id="elh_t9996_employees_Photo"><?php echo $t9996_employees->Photo->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Photo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Notes->Visible) { // Notes ?>
	<tr id="r_Notes">
		<td><span id="elh_t9996_employees_Notes"><?php echo $t9996_employees->Notes->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Notes->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->ReportsTo->Visible) { // ReportsTo ?>
	<tr id="r_ReportsTo">
		<td><span id="elh_t9996_employees_ReportsTo"><?php echo $t9996_employees->ReportsTo->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->ReportsTo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Password->Visible) { // Password ?>
	<tr id="r_Password">
		<td><span id="elh_t9996_employees_Password"><?php echo $t9996_employees->Password->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->UserLevel->Visible) { // UserLevel ?>
	<tr id="r_UserLevel">
		<td><span id="elh_t9996_employees_UserLevel"><?php echo $t9996_employees->UserLevel->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->UserLevel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Username->Visible) { // Username ?>
	<tr id="r_Username">
		<td><span id="elh_t9996_employees_Username"><?php echo $t9996_employees->Username->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Username->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Activated->Visible) { // Activated ?>
	<tr id="r_Activated">
		<td><span id="elh_t9996_employees_Activated"><?php echo $t9996_employees->Activated->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Activated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9996_employees->Profile->Visible) { // Profile ?>
	<tr id="r_Profile">
		<td><span id="elh_t9996_employees_Profile"><?php echo $t9996_employees->Profile->FldCaption() ?></span></td>
...
<?php echo $t9996_employees->Profile->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$t9996_employees_view->Page_Terminate();
?>
