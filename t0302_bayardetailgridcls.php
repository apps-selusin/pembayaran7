...
$t0302_bayardetail_grid = NULL; // Initialize page object first

class ct0302_bayardetail_grid extends ct0302_bayardetail {
	...
	// Page object name
	var $PageObjName = 't0302_bayardetail_grid';

	// Grid form hidden field names
	var $FormName = 'ft0302_bayardetailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t0302_bayardetail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_iuran_id") && $objForm->HasValue("o_iuran_id") && $this->iuran_id->CurrentValue <> $this->iuran_id->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Periode1") && $objForm->HasValue("o_Periode1") && $this->Periode1->CurrentValue <> $this->Periode1->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Periode2") && $objForm->HasValue("o_Periode2") && $this->Periode2->CurrentValue <> $this->Periode2->OldValue)
			return FALSE;
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t0301_bayarmaster") {
			...
			if ($GLOBALS["t0301_bayarmaster"]->EventCancelled) $this->EventCancelled = TRUE;
		}
