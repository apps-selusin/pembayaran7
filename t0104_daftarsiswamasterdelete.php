...
$t0104_daftarsiswamaster_delete = NULL; // Initialize page object first

class ct0104_daftarsiswamaster_delete extends ct0104_daftarsiswamaster {
	...
	// Page object name
	var $PageObjName = 't0104_daftarsiswamaster_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t0104_daftarsiswamasterlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t0104_daftarsiswamaster class, t0104_daftarsiswamasterinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t0104_daftarsiswamasterlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t0104_daftarsiswamaster_delete)) $t0104_daftarsiswamaster_delete = new ct0104_daftarsiswamaster_delete();

// Page init
$t0104_daftarsiswamaster_delete->Page_Init();

// Page main
$t0104_daftarsiswamaster_delete->Page_Main();
...
var CurrentForm = ft0104_daftarsiswamasterdelete = new ew_Form("ft0104_daftarsiswamasterdelete", "delete");

// Form_CustomValidate event
ft0104_daftarsiswamasterdelete.Form_CustomValidate = 
...
ft0104_daftarsiswamasterdelete.ValidateRequired = true;
<?php } else { ?>
ft0104_daftarsiswamasterdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0104_daftarsiswamasterdelete.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0101_tahunajaran"};
ft0104_daftarsiswamasterdelete.Lists["x_sekolah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Sekolah","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0102_sekolah"};
ft0104_daftarsiswamasterdelete.Lists["x_kelas_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kelas","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0103_kelas"};
...
?>
<form name="ft0104_daftarsiswamasterdelete" id="ft0104_daftarsiswamasterdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0104_daftarsiswamaster_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0104_daftarsiswamaster_delete->Token ?>">
<?php } ?>
...
<?php if ($t0104_daftarsiswamaster->tahunajaran_id->Visible) { // tahunajaran_id ?>
		<th><span id="elh_t0104_daftarsiswamaster_tahunajaran_id" class="t0104_daftarsiswamaster_tahunajaran_id"><?php echo $t0104_daftarsiswamaster->tahunajaran_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0104_daftarsiswamaster->sekolah_id->Visible) { // sekolah_id ?>
		<th><span id="elh_t0104_daftarsiswamaster_sekolah_id" class="t0104_daftarsiswamaster_sekolah_id"><?php echo $t0104_daftarsiswamaster->sekolah_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0104_daftarsiswamaster->kelas_id->Visible) { // kelas_id ?>
		<th><span id="elh_t0104_daftarsiswamaster_kelas_id" class="t0104_daftarsiswamaster_kelas_id"><?php echo $t0104_daftarsiswamaster->kelas_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
while (!$t0104_daftarsiswamaster_delete->Recordset->EOF) {
	...
	$t0104_daftarsiswamaster->RowType = EW_ROWTYPE_VIEW; // View
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0104_daftarsiswamaster_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft0104_daftarsiswamasterdelete.Init();
</script>
<?php
...
<?php
$t0104_daftarsiswamaster_delete->Page_Terminate();
?>
