...
$t9997_userlevels_view = NULL; // Initialize page object first

class ct9997_userlevels_view extends ct9997_userlevels {
	...
	// Page object name
	var $PageObjName = 't9997_userlevels_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = "t9997_userlevelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t9997_userlevelslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "t9997_userlevelslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t9997_userlevels_view)) $t9997_userlevels_view = new ct9997_userlevels_view();

// Page init
$t9997_userlevels_view->Page_Init();

// Page main
$t9997_userlevels_view->Page_Main();
...
var CurrentForm = ft9997_userlevelsview = new ew_Form("ft9997_userlevelsview", "view");

// Form_CustomValidate event
ft9997_userlevelsview.Form_CustomValidate = 
...
ft9997_userlevelsview.ValidateRequired = true;
<?php } else { ?>
ft9997_userlevelsview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t9997_userlevels->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t9997_userlevels_view->IsModal) { ?>
<?php if ($t9997_userlevels->Export == "") { ?>
...
<?php
	foreach ($t9997_userlevels_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t9997_userlevels_view->IsModal) { ?>
<?php if ($t9997_userlevels->Export == "") { ?>
...
?>
<form name="ft9997_userlevelsview" id="ft9997_userlevelsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9997_userlevels_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9997_userlevels_view->Token ?>">
<?php } ?>
...
<?php if ($t9997_userlevels->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td><span id="elh_t9997_userlevels_userlevelid"><?php echo $t9997_userlevels->userlevelid->FldCaption() ?></span></td>
...
<?php echo $t9997_userlevels->userlevelid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9997_userlevels->userlevelname->Visible) { // userlevelname ?>
	<tr id="r_userlevelname">
		<td><span id="elh_t9997_userlevels_userlevelname"><?php echo $t9997_userlevels->userlevelname->FldCaption() ?></span></td>
...
<?php echo $t9997_userlevels->userlevelname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$t9997_userlevels_view->Page_Terminate();
?>
