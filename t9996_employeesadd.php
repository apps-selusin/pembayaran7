...
$t9996_employees_add = NULL; // Initialize page object first

class ct9996_employees_add extends ct9996_employees {
	...
	// Page object name
	var $PageObjName = 't9996_employees_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t9996_employeesview.php")
...
// Create page object
if (!isset($t9996_employees_add)) $t9996_employees_add = new ct9996_employees_add();

// Page init
$t9996_employees_add->Page_Init();

// Page main
$t9996_employees_add->Page_Main();
...
var CurrentForm = ft9996_employeesadd = new ew_Form("ft9996_employeesadd", "add");
...
ft9996_employeesadd.Form_CustomValidate = 
...
ft9996_employeesadd.ValidateRequired = true;
<?php } else { ?>
ft9996_employeesadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft9996_employeesadd.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t9997_userlevels"};
ft9996_employeesadd.Lists["x_Activated"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft9996_employeesadd.Lists["x_Activated"].Options = <?php echo json_encode($t9996_employees->Activated->Options()) ?>;
...
?>
<form name="ft9996_employeesadd" id="ft9996_employeesadd" class="<?php echo $t9996_employees_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9996_employees_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9996_employees_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9996_employees_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9996_employeesadd.Init();
</script>
<?php
...
<?php
$t9996_employees_add->Page_Terminate();
?>
