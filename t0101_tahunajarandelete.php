...
$t0101_tahunajaran_delete = NULL; // Initialize page object first

class ct0101_tahunajaran_delete extends ct0101_tahunajaran {
	...
	// Page object name
	var $PageObjName = 't0101_tahunajaran_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t0101_tahunajaranlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t0101_tahunajaran class, t0101_tahunajaraninfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t0101_tahunajaranlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t0101_tahunajaran_delete)) $t0101_tahunajaran_delete = new ct0101_tahunajaran_delete();

// Page init
$t0101_tahunajaran_delete->Page_Init();

// Page main
$t0101_tahunajaran_delete->Page_Main();
...
var CurrentForm = ft0101_tahunajarandelete = new ew_Form("ft0101_tahunajarandelete", "delete");

// Form_CustomValidate event
ft0101_tahunajarandelete.Form_CustomValidate = 
...
ft0101_tahunajarandelete.ValidateRequired = true;
<?php } else { ?>
ft0101_tahunajarandelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0101_tahunajarandelete.Lists["x_Aktif"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0101_tahunajarandelete.Lists["x_Aktif"].Options = <?php echo json_encode($t0101_tahunajaran->Aktif->Options()) ?>;
...
?>
<form name="ft0101_tahunajarandelete" id="ft0101_tahunajarandelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0101_tahunajaran_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0101_tahunajaran_delete->Token ?>">
<?php } ?>
...
<?php if ($t0101_tahunajaran->AwalBulan->Visible) { // AwalBulan ?>
		<th><span id="elh_t0101_tahunajaran_AwalBulan" class="t0101_tahunajaran_AwalBulan"><?php echo $t0101_tahunajaran->AwalBulan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0101_tahunajaran->AwalTahun->Visible) { // AwalTahun ?>
		<th><span id="elh_t0101_tahunajaran_AwalTahun" class="t0101_tahunajaran_AwalTahun"><?php echo $t0101_tahunajaran->AwalTahun->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0101_tahunajaran->AkhirBulan->Visible) { // AkhirBulan ?>
		<th><span id="elh_t0101_tahunajaran_AkhirBulan" class="t0101_tahunajaran_AkhirBulan"><?php echo $t0101_tahunajaran->AkhirBulan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0101_tahunajaran->AkhirTahun->Visible) { // AkhirTahun ?>
		<th><span id="elh_t0101_tahunajaran_AkhirTahun" class="t0101_tahunajaran_AkhirTahun"><?php echo $t0101_tahunajaran->AkhirTahun->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0101_tahunajaran->TahunAjaran->Visible) { // TahunAjaran ?>
		<th><span id="elh_t0101_tahunajaran_TahunAjaran" class="t0101_tahunajaran_TahunAjaran"><?php echo $t0101_tahunajaran->TahunAjaran->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t0101_tahunajaran->Aktif->Visible) { // Aktif ?>
		<th><span id="elh_t0101_tahunajaran_Aktif" class="t0101_tahunajaran_Aktif"><?php echo $t0101_tahunajaran->Aktif->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
while (!$t0101_tahunajaran_delete->Recordset->EOF) {
	...
	$t0101_tahunajaran->RowType = EW_ROWTYPE_VIEW; // View
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0101_tahunajaran_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft0101_tahunajarandelete.Init();
</script>
<?php
...
<?php
$t0101_tahunajaran_delete->Page_Terminate();
?>
