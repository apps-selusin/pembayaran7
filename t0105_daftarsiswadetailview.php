...
$t0105_daftarsiswadetail_view = NULL; // Initialize page object first

class ct0105_daftarsiswadetail_view extends ct0105_daftarsiswadetail {
	...
	// Page object name
	var $PageObjName = 't0105_daftarsiswadetail_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t0105_daftarsiswadetaillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t0105_daftarsiswadetaillist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "t0105_daftarsiswadetaillist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t0105_daftarsiswadetail_view)) $t0105_daftarsiswadetail_view = new ct0105_daftarsiswadetail_view();

// Page init
$t0105_daftarsiswadetail_view->Page_Init();

// Page main
$t0105_daftarsiswadetail_view->Page_Main();
...
var CurrentForm = ft0105_daftarsiswadetailview = new ew_Form("ft0105_daftarsiswadetailview", "view");

// Form_CustomValidate event
ft0105_daftarsiswadetailview.Form_CustomValidate = 
...
ft0105_daftarsiswadetailview.ValidateRequired = true;
<?php } else { ?>
ft0105_daftarsiswadetailview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0105_daftarsiswadetailview.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_NIS","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0201_siswa"};
...
<?php if ($t0105_daftarsiswadetail->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t0105_daftarsiswadetail_view->IsModal) { ?>
<?php if ($t0105_daftarsiswadetail->Export == "") { ?>
...
<?php
	foreach ($t0105_daftarsiswadetail_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t0105_daftarsiswadetail_view->IsModal) { ?>
<?php if ($t0105_daftarsiswadetail->Export == "") { ?>
...
?>
<form name="ft0105_daftarsiswadetailview" id="ft0105_daftarsiswadetailview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0105_daftarsiswadetail_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0105_daftarsiswadetail_view->Token ?>">
<?php } ?>
...
<?php if ($t0105_daftarsiswadetail->siswa_id->Visible) { // siswa_id ?>
	<tr id="r_siswa_id">
		<td><span id="elh_t0105_daftarsiswadetail_siswa_id"><?php echo $t0105_daftarsiswadetail->siswa_id->FldCaption() ?></span></td>
...
<?php echo $t0105_daftarsiswadetail->siswa_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t0105_daftarsiswadetail->Export == "") { ?>
<script type="text/javascript">
ft0105_daftarsiswadetailview.Init();
</script>
<?php } ?>
<?php
...
<?php
$t0105_daftarsiswadetail_view->Page_Terminate();
?>
