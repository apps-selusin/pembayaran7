...
$t9998_userlevelpermissions = NULL;

//
// Table class for t9998_userlevelpermissions
//
class ct9998_userlevelpermissions extends cTable {
	var $userlevelid;
	var $_tablename;
	var $permission;
	...
	function __construct() {
		...
		// userlevelid
		$this->userlevelid = new cField('t9998_userlevelpermissions', 't9998_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new cField('t9998_userlevelpermissions', 't9998_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_tablename->Sortable = TRUE; // Allow sort
		$this->fields['tablename'] = &$this->_tablename;

		// permission
		$this->permission = new cField('t9998_userlevelpermissions', 't9998_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t9998_userlevelpermissions`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t9998_userlevelpermissionsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t9998_userlevelpermissionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t9998_userlevelpermissionsadd.php?" . $this->UrlParm($parm);
		else
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t9998_userlevelpermissionsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t9998_userlevelpermissionsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t9998_userlevelpermissionsdelete.php", $this->UrlParm());
	}
