...
$t9997_userlevels_add = NULL; // Initialize page object first

class ct9997_userlevels_add extends ct9997_userlevels {
	...
	// Page object name
	var $PageObjName = 't9997_userlevels_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t9997_userlevelslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "t9997_userlevelslist.php")
						$sReturnUrl = $this->AddMasterUrl($sReturnUrl); // List page, return to list page with correct master key if necessary
					elseif (ew_GetPageName($sReturnUrl) == "t9997_userlevelsview.php")
...
// Create page object
if (!isset($t9997_userlevels_add)) $t9997_userlevels_add = new ct9997_userlevels_add();

// Page init
$t9997_userlevels_add->Page_Init();

// Page main
$t9997_userlevels_add->Page_Main();
...
var CurrentForm = ft9997_userlevelsadd = new ew_Form("ft9997_userlevelsadd", "add");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9997_userlevels->userlevelid->FldCaption(), $t9997_userlevels->userlevelid->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_userlevelid");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($t9997_userlevels->userlevelid->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_userlevelname");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9997_userlevels->userlevelname->FldCaption(), $t9997_userlevels->userlevelname->ReqErrMsg)) ?>");
...
ft9997_userlevelsadd.Form_CustomValidate = 
...
ft9997_userlevelsadd.ValidateRequired = true;
<?php } else { ?>
ft9997_userlevelsadd.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="ft9997_userlevelsadd" id="ft9997_userlevelsadd" class="<?php echo $t9997_userlevels_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9997_userlevels_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9997_userlevels_add->Token ?>">
<?php } ?>
...
<?php if ($t9997_userlevels->userlevelid->Visible) { // userlevelid ?>
	<div id="r_userlevelid" class="form-group">
		<label id="elh_t9997_userlevels_userlevelid" for="x_userlevelid" class="col-sm-2 control-label ewLabel"><?php echo $t9997_userlevels->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9997_userlevels->userlevelid->CellAttributes() ?>>
<span id="el_t9997_userlevels_userlevelid">
<input type="text" data-table="t9997_userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($t9997_userlevels->userlevelid->getPlaceHolder()) ?>" value="<?php echo $t9997_userlevels->userlevelid->EditValue ?>"<?php echo $t9997_userlevels->userlevelid->EditAttributes() ?>>
</span>
...
<?php if ($t9997_userlevels->userlevelname->Visible) { // userlevelname ?>
	<div id="r_userlevelname" class="form-group">
		<label id="elh_t9997_userlevels_userlevelname" for="x_userlevelname" class="col-sm-2 control-label ewLabel"><?php echo $t9997_userlevels->userlevelname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9997_userlevels->userlevelname->CellAttributes() ?>>
<span id="el_t9997_userlevels_userlevelname">
<input type="text" data-table="t9997_userlevels" data-field="x_userlevelname" name="x_userlevelname" id="x_userlevelname" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($t9997_userlevels->userlevelname->getPlaceHolder()) ?>" value="<?php echo $t9997_userlevels->userlevelname->EditValue ?>"<?php echo $t9997_userlevels->userlevelname->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9997_userlevels_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9997_userlevelsadd.Init();
</script>
<?php
...
<?php
$t9997_userlevels_add->Page_Terminate();
?>
