...
$t9998_userlevelpermissions_view = NULL; // Initialize page object first

class ct9998_userlevelpermissions_view extends ct9998_userlevelpermissions {
	...
	// Page object name
	var $PageObjName = 't9998_userlevelpermissions_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = "t9998_userlevelpermissionslist.php"; // Return to list
			}
			if (@$_GET["_tablename"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t9998_userlevelpermissionslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "t9998_userlevelpermissionslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t9998_userlevelpermissions_view)) $t9998_userlevelpermissions_view = new ct9998_userlevelpermissions_view();

// Page init
$t9998_userlevelpermissions_view->Page_Init();

// Page main
$t9998_userlevelpermissions_view->Page_Main();
...
var CurrentForm = ft9998_userlevelpermissionsview = new ew_Form("ft9998_userlevelpermissionsview", "view");

// Form_CustomValidate event
ft9998_userlevelpermissionsview.Form_CustomValidate = 
...
ft9998_userlevelpermissionsview.ValidateRequired = true;
<?php } else { ?>
ft9998_userlevelpermissionsview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t9998_userlevelpermissions->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t9998_userlevelpermissions_view->IsModal) { ?>
<?php if ($t9998_userlevelpermissions->Export == "") { ?>
...
<?php
	foreach ($t9998_userlevelpermissions_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t9998_userlevelpermissions_view->IsModal) { ?>
<?php if ($t9998_userlevelpermissions->Export == "") { ?>
...
?>
<form name="ft9998_userlevelpermissionsview" id="ft9998_userlevelpermissionsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9998_userlevelpermissions_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9998_userlevelpermissions_view->Token ?>">
<?php } ?>
...
<?php if ($t9998_userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td><span id="elh_t9998_userlevelpermissions_userlevelid"><?php echo $t9998_userlevelpermissions->userlevelid->FldCaption() ?></span></td>
...
<?php echo $t9998_userlevelpermissions->userlevelid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9998_userlevelpermissions->_tablename->Visible) { // tablename ?>
	<tr id="r__tablename">
		<td><span id="elh_t9998_userlevelpermissions__tablename"><?php echo $t9998_userlevelpermissions->_tablename->FldCaption() ?></span></td>
...
<?php echo $t9998_userlevelpermissions->_tablename->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9998_userlevelpermissions->permission->Visible) { // permission ?>
	<tr id="r_permission">
		<td><span id="elh_t9998_userlevelpermissions_permission"><?php echo $t9998_userlevelpermissions->permission->FldCaption() ?></span></td>
...
<?php echo $t9998_userlevelpermissions->permission->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t9998_userlevelpermissions->Export == "") { ?>
<script type="text/javascript">
ft9998_userlevelpermissionsview.Init();
</script>
<?php } ?>
<?php
...
<?php
$t9998_userlevelpermissions_view->Page_Terminate();
?>
