...
$t0302_bayardetail_view = NULL; // Initialize page object first

class ct0302_bayardetail_view extends ct0302_bayardetail {
	...
	// Page object name
	var $PageObjName = 't0302_bayardetail_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t0302_bayardetaillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t0302_bayardetaillist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "t0302_bayardetaillist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t0302_bayardetail_view)) $t0302_bayardetail_view = new ct0302_bayardetail_view();

// Page init
$t0302_bayardetail_view->Page_Init();

// Page main
$t0302_bayardetail_view->Page_Main();
...
var CurrentForm = ft0302_bayardetailview = new ew_Form("ft0302_bayardetailview", "view");

// Form_CustomValidate event
ft0302_bayardetailview.Form_CustomValidate = 
...
ft0302_bayardetailview.ValidateRequired = true;
<?php } else { ?>
ft0302_bayardetailview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0302_bayardetailview.Lists["x_iuran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Iuran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0106_iuran"};
ft0302_bayardetailview.Lists["x_Periode1"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0302_bayardetailview.Lists["x_Periode1"].Options = <?php echo json_encode($t0302_bayardetail->Periode1->Options()) ?>;
ft0302_bayardetailview.Lists["x_Periode2"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0302_bayardetailview.Lists["x_Periode2"].Options = <?php echo json_encode($t0302_bayardetail->Periode2->Options()) ?>;
...
<?php if ($t0302_bayardetail->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t0302_bayardetail_view->IsModal) { ?>
<?php if ($t0302_bayardetail->Export == "") { ?>
...
<?php
	foreach ($t0302_bayardetail_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t0302_bayardetail_view->IsModal) { ?>
<?php if ($t0302_bayardetail->Export == "") { ?>
...
?>
<form name="ft0302_bayardetailview" id="ft0302_bayardetailview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0302_bayardetail_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0302_bayardetail_view->Token ?>">
<?php } ?>
...
<?php if ($t0302_bayardetail->iuran_id->Visible) { // iuran_id ?>
	<tr id="r_iuran_id">
		<td><span id="elh_t0302_bayardetail_iuran_id"><?php echo $t0302_bayardetail->iuran_id->FldCaption() ?></span></td>
...
<?php echo $t0302_bayardetail->iuran_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_bayardetail->Periode1->Visible) { // Periode1 ?>
	<tr id="r_Periode1">
		<td><span id="elh_t0302_bayardetail_Periode1"><?php echo $t0302_bayardetail->Periode1->FldCaption() ?></span></td>
...
<?php echo $t0302_bayardetail->Periode1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_bayardetail->Periode2->Visible) { // Periode2 ?>
	<tr id="r_Periode2">
		<td><span id="elh_t0302_bayardetail_Periode2"><?php echo $t0302_bayardetail->Periode2->FldCaption() ?></span></td>
...
<?php echo $t0302_bayardetail->Periode2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_bayardetail->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td><span id="elh_t0302_bayardetail_Keterangan"><?php echo $t0302_bayardetail->Keterangan->FldCaption() ?></span></td>
...
<?php echo $t0302_bayardetail->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_bayardetail->Jumlah->Visible) { // Jumlah ?>
	<tr id="r_Jumlah">
		<td><span id="elh_t0302_bayardetail_Jumlah"><?php echo $t0302_bayardetail->Jumlah->FldCaption() ?></span></td>
...
<?php echo $t0302_bayardetail->Jumlah->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$t0302_bayardetail_view->Page_Terminate();
?>
