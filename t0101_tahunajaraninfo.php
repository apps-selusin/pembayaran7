...
$t0101_tahunajaran = NULL;

//
// Table class for t0101_tahunajaran
//
class ct0101_tahunajaran extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('t0101_tahunajaran', 't0101_tahunajaran', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// AwalBulan
		$this->AwalBulan = new cField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AwalBulan', 'AwalBulan', '`AwalBulan`', '`AwalBulan`', 16, -1, FALSE, '`AwalBulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AwalTahun
		$this->AwalTahun = new cField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AwalTahun', 'AwalTahun', '`AwalTahun`', '`AwalTahun`', 2, -1, FALSE, '`AwalTahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AkhirBulan
		$this->AkhirBulan = new cField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AkhirBulan', 'AkhirBulan', '`AkhirBulan`', '`AkhirBulan`', 16, -1, FALSE, '`AkhirBulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AkhirTahun
		$this->AkhirTahun = new cField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AkhirTahun', 'AkhirTahun', '`AkhirTahun`', '`AkhirTahun`', 2, -1, FALSE, '`AkhirTahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TahunAjaran
		$this->TahunAjaran = new cField('t0101_tahunajaran', 't0101_tahunajaran', 'x_TahunAjaran', 'TahunAjaran', '`TahunAjaran`', '`TahunAjaran`', 200, -1, FALSE, '`TahunAjaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TahunAjaran->Sortable = TRUE; // Allow sort
		$this->fields['TahunAjaran'] = &$this->TahunAjaran;

		// Aktif
		$this->Aktif = new cField('t0101_tahunajaran', 't0101_tahunajaran', 'x_Aktif', 'Aktif', '`Aktif`', '`Aktif`', 202, -1, FALSE, '`Aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t0101_tahunajaran`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t0101_tahunajaranview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t0101_tahunajaranview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t0101_tahunajaranadd.php?" . $this->UrlParm($parm);
		else
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t0101_tahunajaranedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t0101_tahunajaranadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t0101_tahunajarandelete.php", $this->UrlParm());
	}
