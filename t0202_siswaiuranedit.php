...
$t0202_siswaiuran_edit = NULL; // Initialize page object first

class ct0202_siswaiuran_edit extends ct0202_siswaiuran {
	...
	// Page object name
	var $PageObjName = 't0202_siswaiuran_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t0202_siswaiuranlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t0202_siswaiuran_edit)) $t0202_siswaiuran_edit = new ct0202_siswaiuran_edit();

// Page init
$t0202_siswaiuran_edit->Page_Init();

// Page main
$t0202_siswaiuran_edit->Page_Main();
...
var CurrentForm = ft0202_siswaiuranedit = new ew_Form("ft0202_siswaiuranedit", "edit");
...
ft0202_siswaiuranedit.Form_CustomValidate = 
...
ft0202_siswaiuranedit.ValidateRequired = true;
<?php } else { ?>
ft0202_siswaiuranedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0202_siswaiuranedit.Lists["x_tahunajaran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunAjaran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0101_tahunajaran"};
ft0202_siswaiuranedit.Lists["x_iuran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Iuran","x_Jenis","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0106_iuran"};
...
?>
<form name="ft0202_siswaiuranedit" id="ft0202_siswaiuranedit" class="<?php echo $t0202_siswaiuran_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0202_siswaiuran_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0202_siswaiuran_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t0202_siswaiuran" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t0202_siswaiuran->id->CurrentValue) ?>">
<?php if (!$t0202_siswaiuran_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0202_siswaiuran_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0202_siswaiuranedit.Init();
</script>
<?php
...
<?php
$t0202_siswaiuran_edit->Page_Terminate();
?>
