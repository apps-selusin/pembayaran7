...
$t9998_userlevelpermissions_delete = NULL; // Initialize page object first

class ct9998_userlevelpermissions_delete extends ct9998_userlevelpermissions {
	...
	// Page object name
	var $PageObjName = 't9998_userlevelpermissions_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t9998_userlevelpermissionslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t9998_userlevelpermissions class, t9998_userlevelpermissionsinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t9998_userlevelpermissionslist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t9998_userlevelpermissions_delete)) $t9998_userlevelpermissions_delete = new ct9998_userlevelpermissions_delete();

// Page init
$t9998_userlevelpermissions_delete->Page_Init();

// Page main
$t9998_userlevelpermissions_delete->Page_Main();
...
var CurrentForm = ft9998_userlevelpermissionsdelete = new ew_Form("ft9998_userlevelpermissionsdelete", "delete");

// Form_CustomValidate event
ft9998_userlevelpermissionsdelete.Form_CustomValidate = 
...
ft9998_userlevelpermissionsdelete.ValidateRequired = true;
<?php } else { ?>
ft9998_userlevelpermissionsdelete.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="ft9998_userlevelpermissionsdelete" id="ft9998_userlevelpermissionsdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9998_userlevelpermissions_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9998_userlevelpermissions_delete->Token ?>">
<?php } ?>
...
<?php if ($t9998_userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
		<th><span id="elh_t9998_userlevelpermissions_userlevelid" class="t9998_userlevelpermissions_userlevelid"><?php echo $t9998_userlevelpermissions->userlevelid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9998_userlevelpermissions->_tablename->Visible) { // tablename ?>
		<th><span id="elh_t9998_userlevelpermissions__tablename" class="t9998_userlevelpermissions__tablename"><?php echo $t9998_userlevelpermissions->_tablename->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9998_userlevelpermissions->permission->Visible) { // permission ?>
		<th><span id="elh_t9998_userlevelpermissions_permission" class="t9998_userlevelpermissions_permission"><?php echo $t9998_userlevelpermissions->permission->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
while (!$t9998_userlevelpermissions_delete->Recordset->EOF) {
	...
	$t9998_userlevelpermissions->RowType = EW_ROWTYPE_VIEW; // View
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9998_userlevelpermissions_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft9998_userlevelpermissionsdelete.Init();
</script>
<?php
...
<?php
$t9998_userlevelpermissions_delete->Page_Terminate();
?>
