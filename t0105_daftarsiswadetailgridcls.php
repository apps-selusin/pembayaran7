...
$t0105_daftarsiswadetail_grid = NULL; // Initialize page object first

class ct0105_daftarsiswadetail_grid extends ct0105_daftarsiswadetail {
	...
	// Page object name
	var $PageObjName = 't0105_daftarsiswadetail_grid';

	// Grid form hidden field names
	var $FormName = 'ft0105_daftarsiswadetailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t0105_daftarsiswadetail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t0104_daftarsiswamaster") {
			...
			if ($GLOBALS["t0104_daftarsiswamaster"]->EventCancelled) $this->EventCancelled = TRUE;
		}
