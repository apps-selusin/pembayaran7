...
$t0105_daftarsiswadetail_delete = NULL; // Initialize page object first

class ct0105_daftarsiswadetail_delete extends ct0105_daftarsiswadetail {
	...
	// Page object name
	var $PageObjName = 't0105_daftarsiswadetail_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t0105_daftarsiswadetaillist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t0105_daftarsiswadetail class, t0105_daftarsiswadetailinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t0105_daftarsiswadetaillist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t0105_daftarsiswadetail_delete)) $t0105_daftarsiswadetail_delete = new ct0105_daftarsiswadetail_delete();

// Page init
$t0105_daftarsiswadetail_delete->Page_Init();

// Page main
$t0105_daftarsiswadetail_delete->Page_Main();
...
var CurrentForm = ft0105_daftarsiswadetaildelete = new ew_Form("ft0105_daftarsiswadetaildelete", "delete");

// Form_CustomValidate event
ft0105_daftarsiswadetaildelete.Form_CustomValidate = 
...
ft0105_daftarsiswadetaildelete.ValidateRequired = true;
<?php } else { ?>
ft0105_daftarsiswadetaildelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0105_daftarsiswadetaildelete.Lists["x_siswa_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_NIS","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0201_siswa"};
...
?>
<form name="ft0105_daftarsiswadetaildelete" id="ft0105_daftarsiswadetaildelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0105_daftarsiswadetail_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0105_daftarsiswadetail_delete->Token ?>">
<?php } ?>
...
<?php if ($t0105_daftarsiswadetail->siswa_id->Visible) { // siswa_id ?>
		<th><span id="elh_t0105_daftarsiswadetail_siswa_id" class="t0105_daftarsiswadetail_siswa_id"><?php echo $t0105_daftarsiswadetail->siswa_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
while (!$t0105_daftarsiswadetail_delete->Recordset->EOF) {
	...
	$t0105_daftarsiswadetail->RowType = EW_ROWTYPE_VIEW; // View
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0105_daftarsiswadetail_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft0105_daftarsiswadetaildelete.Init();
</script>
<?php
...
<?php
$t0105_daftarsiswadetail_delete->Page_Terminate();
?>
