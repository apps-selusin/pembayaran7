...
$t9998_userlevelpermissions_edit = NULL; // Initialize page object first

class ct9998_userlevelpermissions_edit extends ct9998_userlevelpermissions {
	...
	// Page object name
	var $PageObjName = 't9998_userlevelpermissions_edit';
	...
	function Page_Main() {
		...
		if ($this->userlevelid->CurrentValue == "") {
			$this->Page_Terminate("t9998_userlevelpermissionslist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t9998_userlevelpermissionslist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "t9998_userlevelpermissionslist.php")
...
// Create page object
if (!isset($t9998_userlevelpermissions_edit)) $t9998_userlevelpermissions_edit = new ct9998_userlevelpermissions_edit();

// Page init
$t9998_userlevelpermissions_edit->Page_Init();

// Page main
$t9998_userlevelpermissions_edit->Page_Main();
...
var CurrentForm = ft9998_userlevelpermissionsedit = new ew_Form("ft9998_userlevelpermissionsedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9998_userlevelpermissions->userlevelid->FldCaption(), $t9998_userlevelpermissions->userlevelid->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_userlevelid");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($t9998_userlevelpermissions->userlevelid->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "__tablename");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9998_userlevelpermissions->_tablename->FldCaption(), $t9998_userlevelpermissions->_tablename->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_permission");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $t9998_userlevelpermissions->permission->FldCaption(), $t9998_userlevelpermissions->permission->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_permission");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($t9998_userlevelpermissions->permission->FldErrMsg()) ?>");
...
ft9998_userlevelpermissionsedit.Form_CustomValidate = 
...
ft9998_userlevelpermissionsedit.ValidateRequired = true;
<?php } else { ?>
ft9998_userlevelpermissionsedit.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="ft9998_userlevelpermissionsedit" id="ft9998_userlevelpermissionsedit" class="<?php echo $t9998_userlevelpermissions_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9998_userlevelpermissions_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9998_userlevelpermissions_edit->Token ?>">
<?php } ?>
...
<?php if ($t9998_userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<div id="r_userlevelid" class="form-group">
		<label id="elh_t9998_userlevelpermissions_userlevelid" for="x_userlevelid" class="col-sm-2 control-label ewLabel"><?php echo $t9998_userlevelpermissions->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9998_userlevelpermissions->userlevelid->CellAttributes() ?>>
<span id="el_t9998_userlevelpermissions_userlevelid">
<span<?php echo $t9998_userlevelpermissions->userlevelid->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t9998_userlevelpermissions->userlevelid->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t9998_userlevelpermissions" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" value="<?php echo ew_HtmlEncode($t9998_userlevelpermissions->userlevelid->CurrentValue) ?>">
...
<?php if ($t9998_userlevelpermissions->_tablename->Visible) { // tablename ?>
	<div id="r__tablename" class="form-group">
		<label id="elh_t9998_userlevelpermissions__tablename" for="x__tablename" class="col-sm-2 control-label ewLabel"><?php echo $t9998_userlevelpermissions->_tablename->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9998_userlevelpermissions->_tablename->CellAttributes() ?>>
<span id="el_t9998_userlevelpermissions__tablename">
<span<?php echo $t9998_userlevelpermissions->_tablename->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t9998_userlevelpermissions->_tablename->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t9998_userlevelpermissions" data-field="x__tablename" name="x__tablename" id="x__tablename" value="<?php echo ew_HtmlEncode($t9998_userlevelpermissions->_tablename->CurrentValue) ?>">
...
<?php if ($t9998_userlevelpermissions->permission->Visible) { // permission ?>
	<div id="r_permission" class="form-group">
		<label id="elh_t9998_userlevelpermissions_permission" for="x_permission" class="col-sm-2 control-label ewLabel"><?php echo $t9998_userlevelpermissions->permission->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t9998_userlevelpermissions->permission->CellAttributes() ?>>
<span id="el_t9998_userlevelpermissions_permission">
<input type="text" data-table="t9998_userlevelpermissions" data-field="x_permission" name="x_permission" id="x_permission" size="30" placeholder="<?php echo ew_HtmlEncode($t9998_userlevelpermissions->permission->getPlaceHolder()) ?>" value="<?php echo $t9998_userlevelpermissions->permission->EditValue ?>"<?php echo $t9998_userlevelpermissions->permission->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9998_userlevelpermissions_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9998_userlevelpermissionsedit.Init();
</script>
<?php
...
<?php
$t9998_userlevelpermissions_edit->Page_Terminate();
?>
