...
$t0302_bayardetail_edit = NULL; // Initialize page object first

class ct0302_bayardetail_edit extends ct0302_bayardetail {
	...
	// Page object name
	var $PageObjName = 't0302_bayardetail_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t0302_bayardetaillist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$KeyValue = isset($rsnew['bayarmaster_id']) ? $rsnew['bayarmaster_id'] : $rsold['bayarmaster_id'];
			if (strval($KeyValue) <> "") {
...
// Create page object
if (!isset($t0302_bayardetail_edit)) $t0302_bayardetail_edit = new ct0302_bayardetail_edit();

// Page init
$t0302_bayardetail_edit->Page_Init();

// Page main
$t0302_bayardetail_edit->Page_Main();
...
var CurrentForm = ft0302_bayardetailedit = new ew_Form("ft0302_bayardetailedit", "edit");
...
ft0302_bayardetailedit.Form_CustomValidate = 
...
ft0302_bayardetailedit.ValidateRequired = true;
<?php } else { ?>
ft0302_bayardetailedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0302_bayardetailedit.Lists["x_iuran_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Iuran","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t0106_iuran"};
ft0302_bayardetailedit.Lists["x_Periode1"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0302_bayardetailedit.Lists["x_Periode1"].Options = <?php echo json_encode($t0302_bayardetail->Periode1->Options()) ?>;
ft0302_bayardetailedit.Lists["x_Periode2"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0302_bayardetailedit.Lists["x_Periode2"].Options = <?php echo json_encode($t0302_bayardetail->Periode2->Options()) ?>;
...
?>
<form name="ft0302_bayardetailedit" id="ft0302_bayardetailedit" class="<?php echo $t0302_bayardetail_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0302_bayardetail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0302_bayardetail_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t0302_bayardetail" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t0302_bayardetail->id->CurrentValue) ?>">
<?php if (!$t0302_bayardetail_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0302_bayardetail_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0302_bayardetailedit.Init();
</script>
<?php
...
<?php
$t0302_bayardetail_edit->Page_Terminate();
?>
