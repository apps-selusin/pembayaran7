...
$t9997_userlevels_delete = NULL; // Initialize page object first

class ct9997_userlevels_delete extends ct9997_userlevels {
	...
	// Page object name
	var $PageObjName = 't9997_userlevels_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t9997_userlevelslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t9997_userlevels class, t9997_userlevelsinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t9997_userlevelslist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t9997_userlevels_delete)) $t9997_userlevels_delete = new ct9997_userlevels_delete();

// Page init
$t9997_userlevels_delete->Page_Init();

// Page main
$t9997_userlevels_delete->Page_Main();
...
var CurrentForm = ft9997_userlevelsdelete = new ew_Form("ft9997_userlevelsdelete", "delete");

// Form_CustomValidate event
ft9997_userlevelsdelete.Form_CustomValidate = 
...
ft9997_userlevelsdelete.ValidateRequired = true;
<?php } else { ?>
ft9997_userlevelsdelete.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="ft9997_userlevelsdelete" id="ft9997_userlevelsdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9997_userlevels_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9997_userlevels_delete->Token ?>">
<?php } ?>
...
<?php if ($t9997_userlevels->userlevelid->Visible) { // userlevelid ?>
		<th><span id="elh_t9997_userlevels_userlevelid" class="t9997_userlevels_userlevelid"><?php echo $t9997_userlevels->userlevelid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t9997_userlevels->userlevelname->Visible) { // userlevelname ?>
		<th><span id="elh_t9997_userlevels_userlevelname" class="t9997_userlevels_userlevelname"><?php echo $t9997_userlevels->userlevelname->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
while (!$t9997_userlevels_delete->Recordset->EOF) {
	...
	$t9997_userlevels->RowType = EW_ROWTYPE_VIEW; // View
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9997_userlevels_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft9997_userlevelsdelete.Init();
</script>
<?php
...
<?php
$t9997_userlevels_delete->Page_Terminate();
?>
