...
$t0101_tahunajaran_view = NULL; // Initialize page object first

class ct0101_tahunajaran_view extends ct0101_tahunajaran {
	...
	// Page object name
	var $PageObjName = 't0101_tahunajaran_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t0101_tahunajaranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t0101_tahunajaranlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "t0101_tahunajaranlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t0101_tahunajaran_view)) $t0101_tahunajaran_view = new ct0101_tahunajaran_view();

// Page init
$t0101_tahunajaran_view->Page_Init();

// Page main
$t0101_tahunajaran_view->Page_Main();
...
var CurrentForm = ft0101_tahunajaranview = new ew_Form("ft0101_tahunajaranview", "view");

// Form_CustomValidate event
ft0101_tahunajaranview.Form_CustomValidate = 
...
ft0101_tahunajaranview.ValidateRequired = true;
<?php } else { ?>
ft0101_tahunajaranview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0101_tahunajaranview.Lists["x_Aktif"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0101_tahunajaranview.Lists["x_Aktif"].Options = <?php echo json_encode($t0101_tahunajaran->Aktif->Options()) ?>;
...
<?php if ($t0101_tahunajaran->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t0101_tahunajaran_view->IsModal) { ?>
<?php if ($t0101_tahunajaran->Export == "") { ?>
...
<?php
	foreach ($t0101_tahunajaran_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t0101_tahunajaran_view->IsModal) { ?>
<?php if ($t0101_tahunajaran->Export == "") { ?>
...
?>
<form name="ft0101_tahunajaranview" id="ft0101_tahunajaranview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0101_tahunajaran_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0101_tahunajaran_view->Token ?>">
<?php } ?>
...
<?php if ($t0101_tahunajaran->AwalBulan->Visible) { // AwalBulan ?>
	<tr id="r_AwalBulan">
		<td><span id="elh_t0101_tahunajaran_AwalBulan"><?php echo $t0101_tahunajaran->AwalBulan->FldCaption() ?></span></td>
...
<?php echo $t0101_tahunajaran->AwalBulan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0101_tahunajaran->AwalTahun->Visible) { // AwalTahun ?>
	<tr id="r_AwalTahun">
		<td><span id="elh_t0101_tahunajaran_AwalTahun"><?php echo $t0101_tahunajaran->AwalTahun->FldCaption() ?></span></td>
...
<?php echo $t0101_tahunajaran->AwalTahun->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0101_tahunajaran->AkhirBulan->Visible) { // AkhirBulan ?>
	<tr id="r_AkhirBulan">
		<td><span id="elh_t0101_tahunajaran_AkhirBulan"><?php echo $t0101_tahunajaran->AkhirBulan->FldCaption() ?></span></td>
...
<?php echo $t0101_tahunajaran->AkhirBulan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0101_tahunajaran->AkhirTahun->Visible) { // AkhirTahun ?>
	<tr id="r_AkhirTahun">
		<td><span id="elh_t0101_tahunajaran_AkhirTahun"><?php echo $t0101_tahunajaran->AkhirTahun->FldCaption() ?></span></td>
...
<?php echo $t0101_tahunajaran->AkhirTahun->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0101_tahunajaran->TahunAjaran->Visible) { // TahunAjaran ?>
	<tr id="r_TahunAjaran">
		<td><span id="elh_t0101_tahunajaran_TahunAjaran"><?php echo $t0101_tahunajaran->TahunAjaran->FldCaption() ?></span></td>
...
<?php echo $t0101_tahunajaran->TahunAjaran->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0101_tahunajaran->Aktif->Visible) { // Aktif ?>
	<tr id="r_Aktif">
		<td><span id="elh_t0101_tahunajaran_Aktif"><?php echo $t0101_tahunajaran->Aktif->FldCaption() ?></span></td>
...
<?php echo $t0101_tahunajaran->Aktif->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$t0101_tahunajaran_view->Page_Terminate();
?>
