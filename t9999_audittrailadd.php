...
$t9999_audittrail_add = NULL; // Initialize page object first

class ct9999_audittrail_add extends ct9999_audittrail {
	...
	// Page object name
	var $PageObjName = 't9999_audittrail_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t9999_audittrailview.php")
...
// Create page object
if (!isset($t9999_audittrail_add)) $t9999_audittrail_add = new ct9999_audittrail_add();

// Page init
$t9999_audittrail_add->Page_Init();

// Page main
$t9999_audittrail_add->Page_Main();
...
var CurrentForm = ft9999_audittrailadd = new ew_Form("ft9999_audittrailadd", "add");
...
ft9999_audittrailadd.Form_CustomValidate = 
...
ft9999_audittrailadd.ValidateRequired = true;
<?php } else { ?>
ft9999_audittrailadd.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="ft9999_audittrailadd" id="ft9999_audittrailadd" class="<?php echo $t9999_audittrail_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9999_audittrail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9999_audittrail_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9999_audittrail_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9999_audittrailadd.Init();
</script>
<?php
...
<?php
$t9999_audittrail_add->Page_Terminate();
?>
